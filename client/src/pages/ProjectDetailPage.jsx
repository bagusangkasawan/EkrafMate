...
import { Briefcase, User, CheckSquare } from 'lucide-react';
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                {userInfo?.role === 'creative' && project.status === 'open' && (
                    <div className="mt-10 border-t pt-8">
                        <button onClick={handleTakeProject} className="w-full md:w-auto bg-indigo-600 text-white px-8 py-3 rounded-md font-semibold hover:bg-indigo-700 shadow-md">
                            Ambil Proyek Ini
                        </button>
                    </div>
                )}
