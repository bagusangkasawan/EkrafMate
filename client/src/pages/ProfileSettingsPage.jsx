// ---------------------------------------------------------------- //
// FILE: pages/ProfileSettingsPage.jsx
// ---------------------------------------------------------------- //
...
import { updateUserInfo } from '../redux/slices/authSlice'; // Import action baru
...
const ProfileSettingsPage = () => {
    ...
    const handleProfileUpdate = async (e) => {
        ...
        try {
            ...
            // Memanggil action Redux untuk memperbarui state secara real-time
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <form onSubmit={handleProfileUpdate} className="space-y-4">
                        ...
                        <button type="submit" disabled={loadingProfile} className="w-full bg-indigo-600 text-white py-2 rounded-md hover:bg-indigo-700 disabled:bg-indigo-400">
                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <form onSubmit={handlePasswordChange} className="space-y-4">
                        <div>
                            ...
                            <input type="password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} className="mt-1 w-full p-2 border rounded-md"/>
                        </div>
                        <div>
                        ...
                        <button type="submit" disabled={loadingPassword} className="w-full bg-gray-700 text-white py-2 rounded-md hover:bg-gray-800 disabled:bg-gray-500">
